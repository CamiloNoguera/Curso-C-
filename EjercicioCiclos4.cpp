/* 28. Escriba un programa que tome cada 4hrs la temperatura exterior,
leyendola durante un periodo de 24hrs. Es decir, debe leer 6 temperaturas.
Calcule la temperatura media del dia, la temperatura más alta y más baja.*/
